...
<body>
    ...
    <div class=" my-container">
        ...
        <div class="container-sm p-3">
            ...
            <div class="card p-3">
                <form class="row g-3" action="<?= base_url('/dashboard/addAction') ?>" method="post">
                    <?= csrf_field() ?>

                    <div class="col-md-6">
                        <label for="kodeItem" class="form-label">Code Item</label>
                        <input type="text" class="form-control" id="kodeItem" name="kodeItem" required>
                    </div>
                    <div class="col-md-6">
                        <label for="namaItem" class="form-label">Name Item</label>
                        <input type="text" class="form-control" id="namaItem" name="namaItem" placeholder="Laptop" required>
                    </div>
                    <div class="col-md-6">
                        <label for="brand" class="form-label">Brand</label>
                        <input type="text" class="form-control" id="brand" name="brand" placeholder="Acer" required>
                    </div>
                    <div class="col-md-6">
                        <label for="warehouse" class="form-label">Warehouse</label>
                        <select class="form-select" id="warehouse" name="warehouse" aria-label="Default select" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="lokasiItem" name="lokasiItem" placeholder="Ruangan Admin" required>
                    </div>
                    <div class="col-md-6">
                        <label for="tglPembelian" class="form-label">Buy Date</label>
                        <input type="date" class="form-control" id="tglPembelian" name="tglPembelian" required>
                    </div>
                    <div class="col-md-6">
                        <label for="pic" class="form-label">Name PIC</label>
                        <input type="text" class="form-control" id="pic" name="pic" required>
                    </div>
                    <div class="col-md-6">
                        <label for="cond" class="form-label">Condition</label>
                        <input type="text" class="form-control" id="cond" name="cond" placeholder="Second / Baru" required>
                    </div>
                    <div class="col-12">
